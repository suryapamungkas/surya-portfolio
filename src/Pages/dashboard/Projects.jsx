...
export default function Projects() {
  ...
  const fetchProjects = async () => {
    ...
    const exportProject = {
      id: "pegiat-ekspor-nusantara",
      Title: "Pegiat Ekspor Nusantara",
      Description: "Sistem platform terintegrasi pendampingan ekspor untuk kelancaran produk lokal Indonesia menembus pasar global.",
      Img: "/pens.png",
    ...
    setProjects([exportProject, ...(data || [])]);
    setLoading(false);
  };
