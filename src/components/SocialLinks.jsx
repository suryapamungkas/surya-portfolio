...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/suryapamungkas",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@suryaszy",
    icon: Instagram,
    url: "https://www.instagram.com/suryaszy",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@suryaszy",
    icon: Youtube,
    url: "https://www.youtube.com/@suryaszy",
    color: "#FF0000",
...
const SocialLinks = () => {
  ...
  return (
    <div className="w-full bg-white/5 border border-white/10 shadow-sm rounded-2xl p-6 py-8 backdrop-blur-xl">
      <h3
        className="text-xl font-semibold text-zinc-100 mb-6 flex items-center gap-2"
        data-aos="fade-down" 
      >
        <span className="inline-block w-8 h-1 bg-zinc-500 rounded-full"></span>
        Connect With Me
      </h3>
        ...
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-zinc-300 tracking-tight leading-none group-hover:text-zinc-100 transition-colors duration-300">
          ...
          {/* External Link */}
          <ExternalLink
            className="relative w-5 h-5 text-zinc-500 group-hover:text-zinc-300
          ...
          {[instagram, youtube].map((link, index) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold text-slate-700 group-hover:text-slate-900 transition-colors duration-300">
                  {link.displayName}
                </span>
              ...
              <ExternalLink
                className="w-4 h-4 text-slate-400 group-hover:text-indigo-600 ml-auto
                                       opacity-0 group-hover:opacity-100 transition-all duration-300
